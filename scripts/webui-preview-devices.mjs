...
export function createDeviceFixture() {
  ...
  return {
    ...
    async tool(body) {
      if (!paused) return {ok:false,text:'请先接管本地预览设备。'};
